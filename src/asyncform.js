...
/**
 * Function for attaching event listeners to forms.
 * This was moved inside a function to allow for
 * later re-initialization of the event listeners – 
 * e.g. when cloning a form via js.
 */
function bootstrapAsyncForm(){
